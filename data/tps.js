...
window.PAINEL_DATA.tps = {
  ...
  mensal: {
    ...
    realizado: [190703, 144740, 117798, 137195, 158042, 101923, 68857, 102679, 75381, 0, 0, 0],
  },

  meta: { real: 75381, saldo: 34619, meta: 110000 },

  kpisTonelagem: {
    planoMedioDiario: 4940,
    realizadoMedioDiario: 5384,
    aderenciaPercent: 109,
    projecaoMensal: 86149,
  },

  kpisVagoes: {
    planoMedioDiario: 54,
    realizadoMedioDiario: 57,
    aderenciaPercent: 106,
    ritmoMedioVgHr: 4.4,
  },

  turno7as19: { tempoMedio: "07:15", vagoesMedio: 30.8 },
  turno19as7: { tempoMedio: "08:02", vagoesMedio: 35.9 },

  planoDiarioVolume: 4940,
  planoRecuperacaoMediaVolume: 5554,
  planoDiarioVagoes: 54,
  planoRecuperacaoMediaVagoes: 59,
  ...
  diarioPorMes: {
    "2026-09": [
      ...
      { dia: 15, data: "15/9/2026", status: "realizado",    volumeRealizado: 8095, vagoesRealizado: 87, vagoesHora: 5.30, horaVagoesHora: "16:25", vagoes7as19: 34, tempo7as19: "07:00", vagoes19as7: 31, tempo19as7: "08:15" },
      ...
      { dia: 17, data: "17/9/2026", status: "realizado",    volumeRealizado: 5580, vagoesRealizado: 65, vagoesHora: 4.17, horaVagoesHora: "15:35", vagoes7as19: 0, tempo7as19: "00:00", vagoes19as7: 0, tempo19as7: "00:00" },
